#!/usr/bin/env python3
"""
LoRA Training Script for lora 5
...
def main():
    try:
        job_id = 58
        logger.info("🚀 Starting LoRA training for lora 5")
        send_output_to_frontend(job_id, "🚀 Starting LoRA training for lora 5")
        
        # Model and data paths
        base_model = "microsoft/DialoGPT-medium"
        train_data_path = "training_data/job_58/train.jsonl"
        val_data_path = "training_data/job_58/val.jsonl"
        output_dir = f"models/lora 5_lora"
        ...
        # Save merged model
        merged_output_dir = f"models/lora 5_lora_merged"
