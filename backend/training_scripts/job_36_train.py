#!/usr/bin/env python3
"""
LoRA Training Script for Quick Test
...
def main():
    try:
        job_id = 36
        logger.info("🚀 Starting LoRA training for Quick Test")
        send_output_to_frontend(job_id, "🚀 Starting LoRA training for Quick Test")
        
        # Job configuration
        
        # Model and data paths
        base_model = "microsoft/DialoGPT-small"
        train_data_path = "training_data/job_36/train.jsonl"
        val_data_path = "training_data/job_36/val.jsonl"
        output_dir = f"models/Quick Test_lora"
        
        # Load model with 4-bit quantization (more memory efficient)
        logger.info("📥 Loading base model...")
        send_output_to_frontend(job_id, f"📥 Loading base model: microsoft/DialoGPT-small")
