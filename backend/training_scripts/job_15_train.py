#!/usr/bin/env python3
"""
LoRA Training Script for amihan-simple
...
def main():
    try:
        logger.info("🚀 Starting LoRA training for amihan-simple")
        
        # Model and data paths
        base_model = "llama3.1:8b"
        train_data_path = "training_data/job_15/train.jsonl"
        val_data_path = "training_data/job_15/val.jsonl"
        output_dir = f"models/amihan-simple_lora"
