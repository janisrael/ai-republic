...
def main():
    try:
        job_id = 50
        logger.info("🚀 Starting LoRA training for echo")
        send_output_to_frontend(job_id, "🚀 Starting LoRA training for echo")
        
        # Model and data paths
        base_model = "microsoft/DialoGPT-medium"
        train_data_path = "training_data/job_50/train.jsonl"
        val_data_path = "training_data/job_50/val.jsonl"
        output_dir = f"models/echo_lora"
        ...
        # Save merged model
        merged_output_dir = f"models/echo_lora_merged"
