...
def main():
    try:
        job_id = 55
        logger.info("🚀 Starting LoRA training for rag2")
        send_output_to_frontend(job_id, "🚀 Starting LoRA training for rag2")
        
        # Model and data paths
        base_model = "microsoft/DialoGPT-medium"
        train_data_path = "training_data/job_55/train.jsonl"
        val_data_path = "training_data/job_55/val.jsonl"
        output_dir = f"models/rag2_lora"
        ...
        # Save merged model
        merged_output_dir = f"models/rag2_lora_merged"
