#!/usr/bin/env python3
"""
LoRA Training Script for lora-working-test
...
def main():
    try:
        logger.info("🚀 Starting LoRA training for lora-working-test")
        ...
        train_data_path = "training_data/job_27/train.jsonl"
        val_data_path = "training_data/job_27/val.jsonl"
        output_dir = f"models/lora-working-test_lora"
